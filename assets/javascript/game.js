// note to self: mistake was setting the variables inside $(document).ready(function() {}); and my reset wouldn't work. SCOPE
...
function reset() {
	...
	// sets initial crystalValue to 0
	$("#crystalValue").text('0');
...
$(document).ready(function() {
	...
	if (counter === targetNumber) {
		reset();
		$("#w-l-notif").text("You Win!").delay(3000).fadeOut('slow');
		$("#w-l-notif").show();
		wins++;
		$("#wins").text("Wins: " + wins);
	}
	...
	if (counter >= targetNumber) {
		reset();
		$("#w-l-notif").text("You Lose!").delay(3000).fadeOut('slow');
		$("#w-l-notif").show();
		losses++
